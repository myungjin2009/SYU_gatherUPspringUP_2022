...
public class TestData {
    ...
    public void buildingInit() {
        ...
        ClassRoom classRoom = new ClassRoom("401호", "4F", silsub1); //TODO 401
        ...
        Lecture lecture = new Lecture(LocalTime.of(10, 00, 00), LocalTime.of(12, 00, 00), "김성완", "리눅스시스템", "화요일", classRoom);
        lectureRepository.save(lecture);

        Student testStudent = new Student("김테스", "testStudent@naver.com", "1234", "고릴라", 1, "backEnd");
        ...
        Student studentHKD = new Student("홍길동", "studentHKD@naver.com", "1234", "홍길이", 3, "designer");
        studentRepository.save(studentHKD);
        Student studentHHS = new Student("황한슬", "studentHHS@syuin.ac.kr", "1234", "슬", 4, "backEnd");
        studentRepository.save(studentHHS);
        Student studentKMJ = new Student("김명진", "myungjin2009@syuin.ac.kr", "1234", "띵진", 4, "backEnd");
        studentRepository.save(studentKMJ);


        Student student = new Student("강감찬", "student@syuin.ac.kr", "5678", "무차니", 3, "frontEnd");
        studentRepository.save(student);
        Board board = new Board("코딩 같이할 사람!!", "3학년 캡스톤디자인 CRUD 같이 공부하실 분 구해봐요", false, student);
        boardRepository.save(board);
        Board board2 = new Board("같이 자료구조 스터디 하실 분", "자료구조 너무 어렵네요.. 백엔드 단에서 설명 가능하신 분", true, studentHHS);
        boardRepository.save(board2);
        Board board3 = new Board("앱 디자인 잘하시는 분!!", "앱디자이너 한 분 모십니다", false, studentHKD);
        ...
        Comment comment2 = new Comment(studentHKD, board2, "와~~~ 저도같이 하고싶네요");
        commentRepository.save(comment2);
        Comment comment3 = new Comment(studentHHS, board2, "그거 한 시간 안에 못하던데");
